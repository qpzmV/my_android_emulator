...
void addComplexTypesPhysicalOrVariablePointersComputeGroup(tcu::TestCaseGroup *group, bool physPtrs)
{
    ...
    // POINTER TYPES //
    ///////////////////
    types += physPtrs ? "%output_buffer_ptr = OpTypePointer PhysicalStorageBufferEXT %output_buffer        \n"
                        ...
                        "%physPtrsStruct = OpTypeStruct %outer_struct_ptr %outer_struct_ptr %input_buffer_ptr "
                        "%output_buffer_ptr\n"
                        "%physPtrsStructPtr     = OpTypePointer StorageBuffer %physPtrsStruct\n"
