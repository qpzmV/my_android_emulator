...
void SparseShaderIntrinsicsCaseStorage::initPrograms(vk::SourceCollections &programCollection) const
{
    ...
    src << "%type_uniformconst_image_residency = OpTypePointer UniformConstant " << typeImageResidencyName
        ...
        << "%constant_uvec4_resident = OpConstantComposite %type_uvec4 %constant_uint_resident "
           "%constant_uint_resident %constant_uint_resident %constant_uint_resident\n"
        ...
        << "%access_GlobalInvocationID_x = OpAccessChain %type_input_uint %input_GlobalInvocationID "
           "%constant_uint_0\n"
        ...
        << "%access_GlobalInvocationID_y = OpAccessChain %type_input_uint %input_GlobalInvocationID "
           "%constant_uint_1\n"
        ...
        << "%access_GlobalInvocationID_z = OpAccessChain %type_input_uint %input_GlobalInvocationID "
           "%constant_uint_2\n"
