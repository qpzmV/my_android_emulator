...
# On Apple Silicon (darwin-aarch64), we prefer to use the system Rust toolchain
# since the prebuilt Rust compiler in AOSP only targets x86_64.
# The CMakeLists.txt already handles this by detecting DARWIN_AARCH64 and
# attempting to use system rust via find_package(Rust).
#
# If you are building natively on an ARM64 Mac, make sure you have Rust installed:
#   curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh
#   rustup target add aarch64-apple-darwin
#
# If you are cross-compiling FROM x86_64 Mac TO aarch64, uncomment the line below
# and ensure you have the aarch64-apple-darwin target installed in your Rust toolchain:
