...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup -arch arm64 -arch x86_64 '
              ...
              '-Wno-unused-command-line-argument -mmacosx-version-min=10.14 '
              '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 -arch x86_64 '
              '-Werror=unguarded-availability '
              '-DHAVE_DYLD_SHARED_CACHE_CONTAINS_PATH=1 -s '
 ...
 'CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv -O3 -Wall '
           ...
           '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 -arch x86_64 '
           '-Werror=unguarded-availability '
           '-DHAVE_DYLD_SHARED_CACHE_CONTAINS_PATH=1',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGURE_CFLAGS': '-arch arm64 -arch x86_64 -isysroot '
                     ...
                     '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 -arch '
                     'x86_64 -Werror=unguarded-availability '
                     '-DHAVE_DYLD_SHARED_CACHE_CONTAINS_PATH=1',
 ...
 'CONFIG_ARGS': "'--prefix=/tmpfs/src/git/out/python3/install' "
                ...
                '-mmacosx-version-min=10.14 -DMACOSX_DEPLOYMENT_TARGET=10.14 '
 ...
 'LIBEXPAT_CFLAGS': '-I/tmpfs/src/git/external/python/cpython3/Modules/expat '
                    ...
                    '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 -arch x86_64 '
                    '-Werror=unguarded-availability '
                    '-DHAVE_DYLD_SHARED_CACHE_CONTAINS_PATH=1 -std=c11 -Wextra '
 ...
 'LIBPL': '/tmpfs/src/git/out/python3/install/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g '
                             ...
                             '-Wno-unused-command-line-argument '
                             '-mmacosx-version-min=10.14 '
                             '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 '
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv '
                        ...
                        '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 -arch '
                        'x86_64 -Werror=unguarded-availability '
                        '-DHAVE_DYLD_SHARED_CACHE_CONTAINS_PATH=1 -std=c11 '
