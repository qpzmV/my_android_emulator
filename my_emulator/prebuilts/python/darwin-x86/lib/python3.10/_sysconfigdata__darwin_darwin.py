...
build_time_vars = {'ABIFLAGS': '',
 ...
 'LIBPL': '/tmpfs/src/git/out/python3/install/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 -arch x86_64 '
                   '-Werror=unguarded-availability '
                   '-DHAVE_DYLD_SHARED_CACHE_CONTAINS_PATH=1 -std=c99 -Wextra '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                        ...
                        '-DMACOSX_DEPLOYMENT_TARGET=10.14 -arch arm64 -arch '
                        'x86_64 -Werror=unguarded-availability '
                        '-DHAVE_DYLD_SHARED_CACHE_CONTAINS_PATH=1 -std=c99 '
