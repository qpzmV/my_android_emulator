...
QT.gui.name = QtGui
QT.gui.module = Qt6GuiAndroidEmu
...
QT.gui.enabled_features = freetype harfbuzz ico sessionmanager texthtmlparser textmarkdownreader textmarkdownwriter textodfwriter cssparser draganddrop action cursor clipboard wheelevent tabletevent im highdpiscaling validator standarditemmodel filesystemmodel imageformatplugin movie imageformat_bmp imageformat_ppm imageformat_xbm imageformat_xpm imageformat_png imageformat_jpeg image_heuristic_mask image_text picture colornames desktopservices systemtrayicon accessibility whatsthis undocommand undostack undogroup
QT.gui.disabled_features = accessibility-atspi-bridge fontconfig opengles2 opengles3 opengles31 opengles32 dynamicgl opengl vulkan openvg egl xcb xcb-glx-plugin system-textmarkdownreader pdf
QT_CONFIG += freetype harfbuzz ico sessionmanager texthtmlparser textmarkdownreader textmarkdownwriter textodfwriter cssparser draganddrop action cursor clipboard wheelevent tabletevent im highdpiscaling validator standarditemmodel filesystemmodel imageformatplugin movie imageformat_bmp imageformat_ppm imageformat_xbm imageformat_xpm imageformat_png imageformat_jpeg image_heuristic_mask image_text picture colornames desktopservices systemtrayicon accessibility whatsthis undocommand undostack undogroup
QT_MODULES += gui
