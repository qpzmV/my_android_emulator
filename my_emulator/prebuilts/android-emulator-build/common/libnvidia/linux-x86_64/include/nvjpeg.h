...
// Number of supported chroma subsamplings aliases
#define NVJPEG_CSS_NUM 7
...
#define NVJPEG_OUTPUT_FMT_NUM 7
...
// Implementation
// NVJPEG_BACKEND_DEFAULT    : defaults to  NVJPEG_BACKEND_GPU_HYBRID
// NVJPEG_BACKEND_HYBRID     : uses CPU for Huffman decode
// NVJPEG_BACKEND_GPU_HYBRID : nvjpegDecodeBatched will use GPU decoding for baseline JPEG images with interleaved scan when batch size is bigger than 100,
//                             it uses CPU for other JPEG types. Other decode APIs will continue to use CPU for Huffman decode
//
typedef enum 
{
